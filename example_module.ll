...
@.const.picklebuf.140345011062080 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([186 x i8], [186 x i8]* @.const.pickledata.140345011062080, i32 0, i32 0), i32 186, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345011062080.sha1, i32 0, i32 0) }
@.const.picklebuf.140345011130816 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.const.pickledata.140345011130816, i32 0, i32 0), i32 69, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345011130816.sha1, i32 0, i32 0) }
@.const.pickledata.140345011130816 = internal constant [69 x i8] c"\80\04\95:\00\00\00\00\00\00\00\8C\08builtins\94\8C\11ZeroDivisionError\94\93\94\8C\10division by zero\94\85\94N\87\94."
@.const.pickledata.140345011130816.sha1 = internal constant [20 x i8] c"\B2\80\08\A0\F8\8B\AD_\F0\F0$>\84\DA\B9\0C\AB\19\B3f"
@.const.pickledata.140345011062080 = internal constant [186 x i8] c"\80\04\95\AF\00\00\00\00\00\00\00\8C\08builtins\94\8C\0DOverflowError\94\93\94)\8C\09int_power\94\8C{/home/runner/.cache/pypoetry/virtualenvs/example-module-IBmFCHpo-py3.9/lib/python3.9/site-packages/numba/cpython/numbers.py\94K\DE\87\94\87\94."
@.const.pickledata.140345011062080.sha1 = internal constant [20 x i8] c"-\08\0E\1C&\BB\EB\140QO\C3\AD\F1\D2\C4\FBT\C9X"
...
@.const.picklebuf.140345010496704 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.const.pickledata.140345010496704, i32 0, i32 0), i32 81, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345010496704.sha1, i32 0, i32 0) }
@.const.picklebuf.140345011062336 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([77 x i8], [77 x i8]* @.const.pickledata.140345011062336, i32 0, i32 0), i32 77, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345011062336.sha1, i32 0, i32 0) }
@.const.picklebuf.140345011132288 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([137 x i8], [137 x i8]* @.const.pickledata.140345011132288, i32 0, i32 0), i32 137, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345011132288.sha1, i32 0, i32 0) }
@.const.picklebuf.140345009602368 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.const.pickledata.140345009602368, i32 0, i32 0), i32 86, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345009602368.sha1, i32 0, i32 0) }
@.const.pickledata.140345009602368 = internal constant [86 x i8] c"\80\04\95K\00\00\00\00\00\00\00\8C\08builtins\94\8C\0BMemoryError\94\93\94\8C'Allocation failed (probably too large).\94\85\94N\87\94."
@.const.pickledata.140345009602368.sha1 = internal constant [20 x i8] c"\BA(\9D\81\F0\\p \F3G|\15sH\04\DFe\AB\E2\09"
@.const.pickledata.140345011132288 = internal constant [137 x i8] c"\80\04\95~\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C[array is too big; `arr.size * arr.dtype.itemsize` is larger than the maximum possible size.\94\85\94N\87\94."
@.const.pickledata.140345011132288.sha1 = internal constant [20 x i8] c"X\E1N\CC\B5\07\B1\E0 i\81t\02#\E6\85\CB\8C<W"
@.const.pickledata.140345011062336 = internal constant [77 x i8] c"\80\04\95B\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C\1Fnegative dimensions not allowed\94\85\94N\87\94."
@.const.pickledata.140345011062336.sha1 = internal constant [20 x i8] c"3\1B\85c\BD\B9\DA\C8\1B8B\22s\05,Ho\C1pk"
@.const.pickledata.140345010496704 = internal constant [81 x i8] c"\80\04\95F\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C#Cannot safely convert value to intp\94\85\94N\87\94."
@.const.pickledata.140345010496704.sha1 = internal constant [20 x i8] c"M\D0\A5\17S\C7\DCs\85\B2u\D9R\BDR\D8\A29\C2\FF"
...
@numba.dynamic.globals.7fa49e7a6720 = linkonce global i8* inttoptr (i32 -1636145376 to i8*)
@numba.dynamic.globals.7fa49e62e0e0 = linkonce global i8* inttoptr (i32 -1637687072 to i8*)
...
@.const.picklebuf.140345009633728 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([76 x i8], [76 x i8]* @.const.pickledata.140345009633728, i32 0, i32 0), i32 76, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140345009633728.sha1, i32 0, i32 0) }
@.const.pickledata.140345009633728 = internal constant [76 x i8] c"\80\04\95A\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C\1Erange() arg 3 must not be zero\94\85\94N\87\94."
@.const.pickledata.140345009633728.sha1 = internal constant [20 x i8] c"\CA\8E\FB:r\D6\14\FE\87 2\CC\E3\AC2`\07\A3\07'"
...
B44:                                              ; preds = %B26
  ...
  store double 0.000000e+00, double* %a.1, align 8
  store { i8*, i32, i8* }* @.const.picklebuf.140345011062080, { i8*, i32, i8* }** %excinfo, align 8
  store i32 0, i32* %try_state, align 4
...
B176.if:                                          ; preds = %B176
  store { i8*, i32, i8* }* @.const.picklebuf.140345011130816, { i8*, i32, i8* }** %excinfo, align 8
...
B0.if:                                            ; preds = %entry
  store { i8*, i32, i8* }* @.const.picklebuf.140345010496704, { i8*, i32, i8* }** %excinfo, align 8
  store i32 0, i32* %try_state, align 4
...
B0.endif.if:                                      ; preds = %B0.endif
  store { i8*, i32, i8* }* @.const.picklebuf.140345011062336, { i8*, i32, i8* }** %excinfo, align 8
...
B0.endif.endif.if:                                ; preds = %B0.endif.endif
  store { i8*, i32, i8* }* @.const.picklebuf.140345011132288, { i8*, i32, i8* }** %excinfo, align 8
  %.35 = load i32, i32* %try_state, align 4
  %.37 = load { i8*, i32, i8* }*, { i8*, i32, i8* }** %excinfo, align 8
  ret i32 1, !ret_is_raise !1
...
B0.if.i.i:                                        ; preds = %B0.endif.endif.endif
  store { i8*, i32, i8* }* @.const.picklebuf.140345009602368, { i8*, i32, i8* }** %excinfo.1.i, align 8, !alias.scope !14, !noalias !15
  store i32 0, i32* %try_state.i.i, align 4, !noalias !10
...
entry:
  ...
  %excinfo.2 = alloca { i8*, i32, i8* }*, align 8
  store { i8*, i32, i8* }* null, { i8*, i32, i8* }** %excinfo.2, align 8
  %.4 = load i8*, i8** @numba.dynamic.globals.7fa49e7a6720, align 8
  store { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] } zeroinitializer, { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] }* %.5, align 8
...
B0.endif:                                         ; preds = %B0.if, %entry
  %.42 = load i8*, i8** @numba.dynamic.globals.7fa49e62e0e0, align 8
  store { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] } zeroinitializer, { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] }* %.43, align 8
  %extracted.meminfo = extractvalue { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] } %inserted.strides, 0
  %extracted.parent = extractvalue { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] } %inserted.strides, 1
  %extracted.nitems = extractvalue { i8*, i8*, i32, i32, i32*, [1 x i32], [1 x i32] } %inserted.strides, 2
...
entry:
  ...
  %try_state = alloca i32, align 4
  store i32 0, i32* %try_state, align 4
  %"$phi26.0" = alloca { i64*, i64, i64, i64* }, align 8
  store { i64*, i64, i64, i64* } zeroinitializer, { i64*, i64, i64, i64* }* %"$phi26.0", align 8
  ...
  %"$phi28.1" = alloca i64, align 8
  store i64 0, i64* %"$phi28.1", align 8
  %.5 = zext i32 0 to i64
...
B26:                                              ; preds = %B26.endif, %B0.endif.endif
  %.1331 = phi i64 [ %s.2.promoted, %B0.endif.endif ], [ %.133, %B26.endif ]
  store { i64, i1 } zeroinitializer, { i64, i1 }* %.84, align 8
  store { i64*, i64, i64, i64* } zeroinitializer, { i64*, i64, i64, i64* }* %.87, align 8
  ...
  br i1 %.94, label %B26.if, label %B26.endif

B40:                                              ; preds = %B26.endif
  store i64 %.118, i64* %"$phi28.1", align 8
  store i64 %.1331, i64* %s.2, align 8
  %.137 = load i64, i64* %"$phi28.1", align 8
  store i64 0, i64* %"$phi28.1", align 8
  %.139 = load { i64*, i64, i64, i64* }, { i64*, i64, i64, i64* }* %"$phi26.0", align 8
...
B0.if:                                            ; preds = %entry
  store { i8*, i32, i8* }* @.const.picklebuf.140345009633728, { i8*, i32, i8* }** %excinfo, align 8
  store i32 0, i32* %try_state, align 4
...
B0.endif.endif:                                   ; preds = %B0.endif.else, %B0.endif.if
  ...
  %.80 = load { i64*, i64, i64, i64* }, { i64*, i64, i64, i64* }* %"$phi26.0", align 8
  ...
  store { i64*, i64, i64, i64* } %.78, { i64*, i64, i64, i64* }* %"$phi26.0", align 8
  ...
  %.83 = load { i64*, i64, i64, i64* }, { i64*, i64, i64, i64* }* %"$phi26.0", align 8
